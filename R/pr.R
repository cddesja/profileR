...
#' @return An object of class \code{prof} is returned, listing the following components:
#' \itemize{
#' \item \code{reliability} - Within-person, between-person, and overall subscore reliability	
