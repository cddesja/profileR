...
``profileR`` has been designed for researchers and practitioners in education, psychology, and medicine in mind with basic statistical knowledge and limited experience with R. It has been used in counseling outcome research [@schmit2019using] and to study learning behavior in mice. The package has also been featured in a handbook on measurement and psychometrics in R [@desjardins2018handbook], has been used in workshops and graduate level courses, is a part of the psychometric CRAN task view, and is downloaded, on average, 752 per month. Our focus on R novice and usability, should help to expand the reach of profile analysis into new scientific fields.
